...
class ConcreteParameters:
    def __init__(self, bitsec, logn, logq, logdivider, logsigpert, logsigsk) -> None:
        self.bitsec = bitsec
        self.logn = logn
        self.n = 2**self.logn
        self.logq = logq
    ...
    def gen_python(self):
        with open("generated_ntru/polyr_params.py", "w") as f:
            ...
            f.write(f"PLOVERSIGN_PHIQ = (PLOVERSIGN_Q1-1) * (PLOVERSIGN_Q2-1)\n")
        ...
        with open("generated_ntru/ploversign_sets.py", "w") as f:
            f.write(f"# generated with params/gen_concrete.py\n\n")
            for d in self.masking_params:
                p = self.masking_params[d]
                f.write(f"plover_128_{d}  = NIST_PloverSign(  bitsec=128, q=PLOVERSIGN_Q, logdivide={self.logdivider}, rep={p['rep']}, ut={p['usk']}, \n\t\t\t\tup={p['upert']}, n=PLOVERSIGN_N, d={d}, sig_rate={self.sig_rate}, sig_sz={self.sig_sz})\n\n")
    ...
    def gen_c(self):
        ...
        with open("generated_ntru/mont64.h", "w") as f:
            f.write(f"""// file generated with params/concrete-param-ring.py
...
""")
        ...
        with open("generated_ntru/ntt64.c", "w") as f:
            f.write(f"""// file generated with params/concrete-param-ring.py
...
""")
        ...
        with open("generated_ntru/param_list.h", "w") as f:
            f.write(f"""// file generated with params/concrete-param-ring.py

#define PLOVER_KAPPA  {self.bitsec}
#define PLOVER_PHIQ   {(valq(self.q1) - 1) * (valq(self.q2) - 1)}L
...
#define PLOVER_PK_SZ  {self.pk_sz}
